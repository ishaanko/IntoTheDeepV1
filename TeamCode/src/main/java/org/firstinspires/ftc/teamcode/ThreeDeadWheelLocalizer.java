...
public final class ThreeDeadWheelLocalizer implements Localizer {
    //public static RobotDataBase robotData = RobotDataBase.defaultType.equals("arm") ?
    //        new RobotDataA(true, "rednear", true, true) :
    //        new RobotDataSwiper(true, "rednear", true);
    ...
    public static class Params {
        ...
        public double par0YTicks = rrparams.par0YTicks; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = rrparams.par1YTicks; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = rrparams.perpXTicks; // x position of the perpendicular encoder (in tick units)
    }
    ...
    public ThreeDeadWheelLocalizer(HardwareMap hardwareMap, double inPerTick) {
        ...
        if (RobotDataBase.defaultType.equals("arm")) {
            ...
            par1 = new OverflowEncoder(new RawEncoder(hardwareMap.get(DcMotorEx.class, "rearright")));
            ...
            //par0 = new OverflowEncoder(new RawEncoder(hardwareMap.get(DcMotorEx.class, "rearleft")));
